...
public sealed class AppDataPersistenceTests
{
    ...
    public void JsonRoundTrip_PreservesRosterSessionsAndAttendance()
    {
        ...
        var participant = new Participant { ExerciseIds = [exercise.Id], FirstName = "Ada", Surname = "Lind", PersonalNumber = "200101011234" };
        ...
        Assert.AreEqual(exercise.Id, restored.Participants[0].ExerciseIds.Single());
